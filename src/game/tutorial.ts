...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  {
    id: 'chain',
    text: 'Maintenant ramasse <b>3 pixels de la même couleur</b> à la suite.<br>Vise-les : les autres couleurs ne sont pas aspirées.',
    focus: 'pixels',
    freeze: false,
  ...
  {
    id: 'mult',
    text: 'C\'est ta <b>chaîne</b>. Chaque pixel de la même couleur vaut <b>de plus en plus cher</b> :<br>+10 tout seul, mais <b>+50</b> au cinquième d\'affilée.',
    focus: 'mult',
    freeze: true,
    button: 'MONTRE-MOI',
  },
  {
    id: 'chain5',
    text: 'Enchaîne <b>5 pixels de la même couleur</b> et regarde les nombres grimper.<br>Astuce : l\'aimant n\'attire que ta couleur en cours.',
    focus: 'pixels',
    freeze: false,
  ...
  {
    id: 'end',
    text: 'Tu sais tout.<br>Enchaîne les couleurs, <b>banque avant de te faire toucher</b>.<br>La <b>RUN DU JOUR</b> du menu, c\'est la même partie pour tout le monde : parfait pour défier tes potes.',
    focus: null,
    freeze: true,
