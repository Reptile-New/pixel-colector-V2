...
export const SPECIMENS: readonly Specimen[] = [
  ...
  { id: 18, name: 'CHAÎNE', rarity: 'commun', lore: 'Chaque maillon connaît la couleur du suivant.', cond: { kind: 'chain', v: 8 } },
  { id: 19, name: 'PERSISTANT', rarity: 'commun', lore: 'Rémanence sur le phosphore. Refuse de partir.', cond: { kind: 'runs', v: 15 } },

  { id: 20, name: 'AVARE', rarity: 'rare', lore: 'A gardé 2 000 points en poche. Les a tous perdus.', cond: { kind: 'bankOne', v: 2000 } },
  ...
  { id: 26, name: 'MULTIPLICATEUR', rarity: 'rare', lore: '×11. Le chiffre où les mains commencent à trembler.', cond: { kind: 'mult', v: 11 } },
  ...
  { id: 31, name: 'CASCADE', rarity: 'rare', lore: 'Une chaîne de 14 ne se produit pas par accident.', cond: { kind: 'chain', v: 14 } },
  { id: 32, name: 'MONOLITHE', rarity: 'rare', lore: '18 000 points, gravés dans le buffer permanent.', cond: { kind: 'score', v: 18000 } },
  { id: 33, name: 'VÉTÉRAN', rarity: 'rare', lore: 'Quarante écrans morts. Il ne les compte plus.', cond: { kind: 'runs', v: 40 } },

  { id: 34, name: 'USURIER', rarity: 'epique', lore: 'A banqué 6 000 d\'un seul coup. L\'écran a hurlé.', cond: { kind: 'bankOne', v: 6000 } },
  ...
  { id: 37, name: 'HYPNOSE', rarity: 'epique', lore: 'Chaîne 20. Tu as arrêté de réfléchir, tu joues enfin.', cond: { kind: 'chain', v: 20 } },
  { id: 38, name: 'SEPT-JOURS', rarity: 'epique', lore: 'Une semaine. Le jeu te connaît mieux que tes amis.', cond: { kind: 'streak', v: 7 } },
  { id: 39, name: 'ORACLE', rarity: 'epique', lore: '×17. Tu vois les spawns avant qu\'ils n\'existent.', cond: { kind: 'mult', v: 17 } },
  { id: 40, name: 'DÉLUGE', rarity: 'epique', lore: '400 pixels dans une seule vie. L\'écran est vide.', cond: { kind: 'runCollected', v: 400 } },
  { id: 41, name: 'CENT-MILLE', rarity: 'epique', lore: '60 000. Peu de gens verront cette carte.', cond: { kind: 'score', v: 60000 } },
  ...
  { id: 43, name: 'LE COLLECTEUR', rarity: 'legendaire', lore: 'Le pixel originel. Il collectionnait déjà avant l\'affichage.', cond: { kind: 'score', v: 150000 } },
  ...
  { id: 45, name: 'SINGULARITÉ', rarity: 'legendaire', lore: 'Chaîne 26. Une seule couleur, vingt-six fois de suite.', cond: { kind: 'chain', v: 26 } },
